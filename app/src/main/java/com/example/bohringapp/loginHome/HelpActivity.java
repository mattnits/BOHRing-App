...
public class HelpActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = bundle.getString("HelpUsername");
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (menuItem.getItemId() == 2131362060) {
                            ...
                            Intent intent = new Intent(HelpActivity.this, CourseContent.class);
                            intent.putExtra("USER_ID", username);
                            startActivity(intent);
                            drawerLayout.closeDrawers();
                            finish();
                            ...
                            Intent intent = new Intent(HelpActivity.this, EnrollmentActivity.class);
                            intent.putExtra("USER_ID", username);
                            startActivity(intent);
                            drawerLayout.closeDrawers();
                            finish();
                            ...
                            Intent intent = new Intent(HelpActivity.this, CourseActivity.class);
                        ...
                        //Log.i("MenuOnClick", ""+menuItem.getItemId());
